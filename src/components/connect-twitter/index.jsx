  ...
  return (
    <div className="connect_twitter">
      <ReCAPTCHA
        ...
        size="invisible"
      />
      <div className="connect_twitter__button" onClick={onClick}>
        <img
          src={Logo}
          alt="twitter"
        ...
        <div className="connect_twitter__button__text">
          {twitterName ? "Connect Again" : " Connect Twitter"}
        </div>
      </div>
      {twitterName && (
        <div className="connect_twitter__success">
          {`- You are successfully connected `} <b>{twitterName}!</b>
        </div>
      )}
    </div>
  );
